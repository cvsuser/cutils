...
#ifndef UTILS_TESTHARNESS_H_
#define UTILS_TESTHARNESS_H_
...
// environment variable "UNIT_TESTS" is not set, runs all tests.
// Otherwise, runs only the tests whose name contains the value of
// "UNIT_TESTS" as a substring.  E.g., suppose the tests are:
//    TEST(Foo, Hello) { ... }
//    TEST(Foo, World) { ... }
// UNIT_TESTS=Hello will run the first test
// UNIT_TESTS=o     will run both tests
// UNIT_TESTS=Junk  will run no tests
//
